defmodule Goliath.Credits.Persistence.Repo.Migrations.CreateQuota do
  ...
  def change do
    create table(:quota, primary_key: false) do
      ...
      add(:start_utc_datetime, :utc_datetime, null: false)
      add(:due_utc_datetime, :utc_datetime, null: false)
      add(:payment_utc_datetime, :utc_datetime, null: true)
      ...
      add(:previous_payment_utc_datetime, :utc_datetime, null: true)
